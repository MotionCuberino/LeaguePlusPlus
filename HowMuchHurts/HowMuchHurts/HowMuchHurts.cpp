// Howmuchhurts.cpp : Defines the exported functions for the DLL application.
//

#include "PluginSDK.h"
#include "Indicator.h"

PluginSetup("How much hurts - MotionCuber");
...
void Menu()
{
	MainMenu = GPluginSDK->AddMenu("How much hurts");
...
PLUGIN_API void OnLoad(IPluginSDK* PluginSDK)
{
	...
	Menu();
	Spells();
	GGame->PrintChat("How much hurts Loaded!");
